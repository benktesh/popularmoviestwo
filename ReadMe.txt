...
Sources for Stage 2:
Passing multiple parameters to async tasks
...
- Used data binding for detailed activity
- Handled app crashing while starting up when there was no-network event caused by empty item list.
- Added some design time tools (text and item count)
...
- Used https://inthecheesefactory.com/blog/understand-android-activity-launchmode/en to understand the launch mode and single task to persist the view
